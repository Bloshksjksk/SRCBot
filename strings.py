strings = {
    ...
    'privacy_policy': "#Note You have 1 minutes to read this\n\n⚠️ Disclaimer ⚠️\nAll the media downloaded are obtained from your account. we don't care what you upload, and also we don't log them.\nYou solely bear all the consequenses.\nAfter the /logout you need to check in Telegram Settings > Devices if extra session is active remove it..It Was Generated By you\nDont use Bot Frequently Coz Telegram Watch You How Fair you Do Give some rest to the bot otherwise your acount may got banned🚫\n\nIf read the above message then click /tb",
