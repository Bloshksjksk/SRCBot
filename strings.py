strings = {
    ...
    'privacy_policy': "⚠️ All the media downloaded are obtained from your account. we don't care what you upload, and also we don't log them. You solely bear all the consequenses after the /logout you need to check in Telegram Settings>Devices if extra session is active remove it.. \n It Was Generated By you \nDont use Bot Frequently Coz Telegram Watch You How Fair you Do Give some rest to the bot otherwise your acount may got banned🚫",
